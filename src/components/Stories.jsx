...
const Stories = ({ story: { title, news } }) => {
  ...
  return (
    <>
      <div className='wrapper nike-container mb-11'>
        <Title title={title} />
        <div className='splide mt-7'>
          <Splide options={splideOptions}>
            {news.map((val, i) => (
              <SplideSlide key={i} className='mb-0.5'>
                <div className='wrapper relative grid items-center gap-4 pb-2 rounded-lg shadow shadow-slate-200 ring-1 ring-slate-200'>
                  ...
                  <div className='icon flex items-center justify-between w-full px-4'>
                  ...
                  <div className='heading-container grid items-center justify-items-start px-4'>
                  ...
                  <div className='btn flex items-center justify-center px-4 w-full'>
                    <a
                      href={val.url}
                      target='_blank'
                      role={'button'}
