  ...
  return (
    <>
      <div className='relative h-auto w-auto flex flex-col'>
        <div className='bg-theme clip-path h-[85vh] lg:h-[75vh] md:h-[65vh] sm:h-[55vh] w-auto absolute top-o left-0 right-0 opacity-100 z-10'></div>
        <div className='relative opacit-100 z-20 grid items-center justify-items-center nike-container'>
